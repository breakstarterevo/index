...
def build_app_youth_intake_payload(app_source, rating_lookup=None):
    ...
    return {
        ...
        "manualAwards": list(app_source.get("manualAwards", [])),
        "awardTransactions": list(app_source.get("awardTransactions", [])),
        "awardsRevision": int(app_source.get("awardsRevision", 0) or 0),
        "awardsUpdatedAt": app_source.get("awardsUpdatedAt", ""),
        "awardsHash": app_source.get("awardsHash", ""),
